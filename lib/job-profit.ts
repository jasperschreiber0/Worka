...
export function calculateJobProfit(input: {
  ...
  if (input.outstandingCommitments < 0 || (input.remaining !== null && input.remaining < 0) || input.uncostedHours < 0) throw new Error('Outstanding commitments, remaining costs and hours cannot be negative')
